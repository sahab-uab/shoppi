        ...
        >
          <div className="w-full">
            <div className="w-full md:h-[600px] h-[350px] border border-qgray-border flex justify-center items-center overflow-hidden relative mb-3">
              ...
              />
              {product.offer_price && (
                <div className="w-[80px] h-[80px] rounded-full bg-[#101010] text-qblack flex justify-center items-center text-xl font-medium absolute left-[30px] top-[30px]">
          ...
          <div className="product-details w-full mt-10 lg:mt-0">
            ...
            {seller && (
                <div data-aos="fade-up" className="message-btn">
                  <button onClick={()=>popupMessageHandler()} className="flex px-5 py-2 bg-[#101010] text-qblack items-center space-x-2.5" type="button">
                <span>
