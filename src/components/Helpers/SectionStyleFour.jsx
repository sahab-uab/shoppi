      ...
      >
        <div className="container-x mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8">
            ...
            <div
              className={`space-y-4 opacity-0 ${
                isLoaded ? "animate-slide-in-right stagger-3" : ""
              }`}
            >
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="mb-4 md:mb-0">
                    ...
                    <p className="text-gray-600">
                      Handpicked selection based on customer reviews, quality,
                      and popularity
                    </p>
                  </div>
...
function ProductRowCard({
  ...
  return (
    <div
      className="product-row group  relative border-black/15 shadow-sm bg-white rounded-xl  hover:shadow-lg border  hover:border-blue-200 p-4 cursor-pointer overflow-hidden "
      ...
      <Link href={`/single-product?slug=${product.slug}`}>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-grow min-w-0">
            ...
            {/* Product Title */}
            <h3 className="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-300 line-clamp-1 text-sm mb-2 leading-tight">
              {product.title}
            </h3>
