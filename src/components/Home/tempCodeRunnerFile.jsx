    ...
    <>
      ...
      <div className="w-full bg-gradient-to-b from-white to-gray-50 py-16">
        <div className="container-x mx-auto px-4">
          ...
          <div
            className={`opacity-0 ${
              isLoaded ? "animate-scale-in stagger-2" : ""
            }`}
          >
            <Swiper
              spaceBetween={12}
...
<div className="relative w-full max-w-[240px] bg-white rounded-2xl shadow-lg hover:shadow-2xl border-2 border-gray-100 hover:border-blue-200 p-6 transition-all duration-400 overflow-visible">
                        ...
                        {/* Top‑Seller Badge (now free to overflow) */}
                        {index < 3 && (
                          <div className="absolute -top-2 -right-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-xs px-2 py-1 rounded-full font-bold shadow-lg z-20 overflow-hidden whitespace-nowrap">
                            ⭐ Top
                          </div>
                        )}
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="mb-4 md:mb-0">
                  ...
                  <p className="text-gray-600">
                    All our featured sellers are verified, highly‑rated, and
