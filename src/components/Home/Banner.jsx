          ...
          <div className="main-wrapper w-full">
            ...
            >
              {services.map((service, index) => (
                <div
                  key={service.id}
                  className={`min-w-[140px] sm:min-w-[160px] md:min-w-[200px] border-r-2 sm:border-r-3 md:border-r-4 border-[#101010] border-opacity-85 px-2 sm:px-4 md:px-6 py-2 flex-shrink-0 transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 ${
