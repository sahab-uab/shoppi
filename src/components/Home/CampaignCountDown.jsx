      ...
      <div className={`w-full -mt-20 md:-mt-5 lg:h-[460px]  ${className || ""}`}>
        <div className="container-x mx-auto h-full">
          <div className="lg:flex xl:space-x-[20px] lg:space-x-4 rtl:space-x-reverse items-center h-full">
            <div
              data-aos="fade-right"
              className="campaign-countdown  shadow-md rounded-sm  border-1 lg:w-1/2 group h-[300px] sm:h-[400px] lg:h-full w-full mb-5 lg:mb-0 "
              style={{
                background: `url(${
            ...
            <div
              data-aos="fade-left"
              className="download-app shadow-md rounded-sm  border-1 flex-1 lg:h-full h-[430px] xl:p-12 p-5"
              style={{
                backgroundImage: `url(${
                  downloadData.image
