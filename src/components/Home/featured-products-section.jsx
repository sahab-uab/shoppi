...
export default function FeaturedProductsSection({
  ...
  const filteredProducts = processedProducts.filter(
    (item) => item.category_id === selectedId
  );
      ...
      >
        <div className="container-x mx-auto px-4">
          ...
          <div className="grid xl:grid-cols-6 lg:grid-cols-4 gap-6">
            ...
            <div
              className={`xl:col-span-1 lg:col-span-1 opacity-0 ${
                isLoaded ? "animate-slide-in-left stagger-1" : ""
              }`}
            >
              <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden h-fit">
                {/* Sidebar Header */}
                <div className="relative h-48 bg-gradient-to-br from-gray-500 to-gray-900 overflow-hidden">
                  {categoryBackground && (
                    <Image
                  ...
                  <div className="space-y-2">
                    {categories.map((category, index) => (
                      <button
                        ...
                        disabled={isLoading}
                        className={`category-item w-full border text-left px-4 py-3 rounded-xl transition-all duration-300 flex items-center justify-between group ${
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-3">
                          {/* Numbered Badge */}
                          <div className="w-6 h-6 flex items-center justify-center rounded-full bg-gray-200 text-gray-700 font-bold text-xs group-hover:bg-gray-300">
                            {index + 1}
                          </div>
              ...
              {isLoading ? (
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
                  {filteredProducts.slice(0, 6).map((product, index) => (
                    <div
                      key={product.id}
                      className={`product-card group bg-white rounded-xl shadow-sm hover:shadow-xl border border-gray-100 hover:border-purple-200 overflow-hidden opacity-0 ${
                        isLoaded && !isLoading
                    ...
                    >
                      ...
                      <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                        ...
                        <div className="absolute top-3 right-3 z-10">
                          <div className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg flex items-center">
                            <svg
                      ...
                      <div className="p-4">
                        ...
                        <Link href={`/single-product?slug=${product.slug}`}>
                          <button className="w-full bg-gray-900 hover:from-purple-700 hover:to-blue-700 text-white py-2 px-4 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
                            Add To Cart
                          </button>
                        </Link>
                      </div>
